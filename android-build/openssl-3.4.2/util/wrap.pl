...
BEGIN {
    ...
    require '/Users/ngominhtoan/Desktop/MyProject/build_pjsip/android-build/openssl-3.4.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/ngominhtoan/Desktop/MyProject/build_pjsip/android-build/openssl-3.4.2/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/Users/ngominhtoan/Desktop/MyProject/build_pjsip/android-build/openssl-3.4.2/test/default-and-jitter.cnf';
    shift;
